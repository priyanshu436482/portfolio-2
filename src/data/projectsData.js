...
export const techMarqueeItems = [
  { imgUrl: '/icons/react-original.svg', label: 'React' },
  { imgUrl: '/icons/angular-original.svg', label: 'Angular' },
  { imgUrl: '/icons/vuejs-original.svg', label: 'Vue.js' },
  { imgUrl: '/icons/dotnetcore-original.svg', label: '.NET Core' },
  { imgUrl: '/icons/nodejs-original.svg', label: 'Node.js' },
  { imgUrl: '/icons/postgresql-original.svg', label: 'PostgreSQL' },
  { imgUrl: '/icons/azuresqldatabase-original.svg', label: 'SQL Server' },
  { imgUrl: '/icons/mongodb-original.svg', label: 'MongoDB' },
  { imgUrl: '/icons/flutter-original.svg', label: 'Flutter' },
  { imgUrl: '/icons/azure-original.svg', label: 'Azure' },
  { imgUrl: '/icons/amazonwebservices-original-wordmark.svg', label: 'AWS' },
  { imgUrl: '/icons/docker-original.svg', label: 'Docker' },
  { icon: 'fa-solid fa-brain', color: 'text-purple-500', label: 'AI / LLM' },
  { imgUrl: '/icons/python-original.svg', label: 'Python' },
  { imgUrl: '/icons/php-original.svg', label: 'PHP' },
  { imgUrl: '/icons/laravel-original.svg', label: 'Laravel' },
  { imgUrl: '/icons/wordpress-plain.svg', label: 'WordPress' },
  { imgUrl: '/icons/javascript-original.svg', label: 'JavaScript' },
  { imgUrl: '/icons/html5-original.svg', label: 'HTML/CSS' },
  { imgUrl: '/icons/figma-original.svg', label: 'Figma' },
];
