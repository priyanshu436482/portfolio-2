...
export const techMarqueeItems = [
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/react/react-original.svg', label: 'React' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/angular/angular-original.svg', label: 'Angular' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/vuejs/vuejs-original.svg', label: 'Vue.js' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/dotnetcore/dotnetcore-original.svg', label: '.NET Core' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/nodejs/nodejs-original.svg', label: 'Node.js' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/postgresql/postgresql-original.svg', label: 'PostgreSQL' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/azuresqldatabase/azuresqldatabase-original.svg', label: 'SQL Server' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/mongodb/mongodb-original.svg', label: 'MongoDB' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/flutter/flutter-original.svg', label: 'Flutter' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/azure/azure-original.svg', label: 'Azure' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/amazonwebservices/amazonwebservices-original-wordmark.svg', label: 'AWS' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/docker/docker-original.svg', label: 'Docker' },
  { icon: 'fa-solid fa-brain', color: 'text-purple-500', label: 'AI / LLM' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/python/python-original.svg', label: 'Python' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/php/php-original.svg', label: 'PHP' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/laravel/laravel-original.svg', label: 'Laravel' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/wordpress/wordpress-plain.svg', label: 'WordPress' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/javascript/javascript-original.svg', label: 'JavaScript' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/html5/html5-original.svg', label: 'HTML/CSS' },
  { imgUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/icons/figma/figma-original.svg', label: 'Figma' },
];
